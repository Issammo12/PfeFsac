        ...
        <aside class="sidebar">
            ...
            <ul>
                <li>
                    <a href="/projet/pages/Entreprise/SaisieOffre.page.php">
                        <i class="icon fas fa-upload"></i>
                        <span class="text">Publier une offre</span>
                    </a>
                </li>
                <li>
                    <a href="/projet/pages/Entreprise/ModifierProfil.page.php">
                        <i class="icon fas fa-user"></i>
                        <span class="text">Modifier votre profil</span>
                    </a>
                </li>
                <li>
                    <a href="/projet/pages/Entreprise/MesOffres.page.php">
