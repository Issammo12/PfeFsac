    ...
    <div class="wrapper">
        ...
        <form action="../auth/inscription.php" method="post">
            <div class="form-container">
                ...
                <?php 
                // Affichage du message d'erreur pour les mots de passe non correspondants
                if(isset($_GET['mdp_err']) && $_GET['mdp_err'] === 'not_match') {
                    echo '<p style="color: red;">Les mots de passe ne correspondent pas.</p>';
                }
                // Affichage du message d'erreur pour l'e-mail existant
                if(isset($_GET['email_err']) && $_GET['email_err'] === 'exists') {
